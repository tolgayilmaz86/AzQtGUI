...
namespace AzQtComponents
{
        ...
        , m_configuration(toastConfiguration)
    {
        ...
        m_lifeSpan.setInterval(static_cast<int>(toastConfiguration.m_duration.count()));
    ...
    void ToastNotification::UpdatePosition(const QPoint& screenPosition, const QPointF& anchorPoint)
    {
        ...
        finalPosition.setX(static_cast<int>(screenPosition.x() - dialogGeometry.width() * anchorPoint.x()));
        finalPosition.setY(static_cast<int>(screenPosition.y() - dialogGeometry.height() * anchorPoint.y()));
